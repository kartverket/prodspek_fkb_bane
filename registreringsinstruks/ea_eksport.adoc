...
'''
.Illustrasjon av hvordan Jernbaneplattformkant skal registreres
image::figurer/plattform.png[link=figurer/plattform.png, Alt="Illustrasjon av hvordan Jernbaneplattformkant skal registreres"]
 
 
'''
.Illustrasjon av hvordan Jernbaneplattformkant (rødt) skal registreres sammen med AnnetVegarealAvgrensning (blått)
image::figurer/plattform2.png[link=figurer/plattform2.png, Alt="Illustrasjon av hvordan Jernbaneplattformkant (rødt) skal registreres sammen med AnnetVegarealAvgrensning (blått)"]
...
'''
.Illustrasjon av hvor nodepunkt skal plasseres i forhold til sporveksel. Knutepunktet plasseres i skjæringspunktet for Spormidt og normalen fra drivmaskinen ned på Spormidt
image::figurer/sporveksel.png[link=figurer/sporveksel.png, Alt="Illustrasjon av hvor nodepunkt skal plasseres i forhold til sporveksel. Knutepunktet plasseres i skjæringspunktet for Spormidt og normalen fra drivmaskinen ned på Spormidt"]
